...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='../datasets/MPIIFaceGaze-New/Image', type=str)
    parser.add_argument(
        '--gazeMpiilabel_dir', dest='gazeMpiilabel_dir', help='Directory path for gaze labels.',
        default='../datasets/MPIIFaceGaze-New/Label', type=str)
        ...
        for fold in range(15):
            ...
            for epoch in range(num_epochs):
                ...
                if epoch % 1 == 0 and epoch < num_epochs:
                    print('Taking snapshot...',
                        torch.save(model.state_dict(),
                                    f'{output}/{summary_name}/fold{str(fold)}/_epoch_{str(epoch+1)}.pkl')
                        )
